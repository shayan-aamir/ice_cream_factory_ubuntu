...
void *handler2 (void *ptr)
{
   ...
   printf("\nicecream arrived at COUNTER3 'Chocolate COUNTER' with delay of 2 seconds\n");
...
void *handler3 (void *ptr)
{
   ...
   printf("\nicecream arrived at COUNTER4 'Mango COUNTER' with delay of 2 seconds\n");
...
void *handler4 (void *ptr)
{
   ...
   printf("\nicecream arrived at COUNTER5 'Stawbery COUNTER' with delay of 2 seconds\n");
...
void *handler5 (void *ptr)
{
   ...
   printf("\norder of icecream arrived at COUNTER6 'Vanila COUNTER' with delay of 2 seconds\n");
...
void *handler6 (void *ptr)
{
   ...
   printf("\nicecream arrived at COUNTER7 'Kulfa COUNTER' with delay of 2 seconds\n");
...
void *handler7 (void *ptr)
{
   ...
   printf("\nicecream arrived at COUNTER8 'EXTRA TOPPING COUNTER' with delay of 2 seconds\n");
...
void *handler8 (void *ptr)
{
   ...
   printf("\nicecream arrived at COUNTER9 'SPECIAL FLAVOURED CREAM COUNTER' with delay of 2 seconds\n");
...
void *handler9 (void *ptr)
{
   ...
   printf("\nicecream arrived at COUNTER10 'PACKAGING AND SERVING COUNTER' with delay of 2 seconds\n");
